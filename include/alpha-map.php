...
final class Alpha_Google_Map_For_Elementor {
	...
	public function __construct() {
		...
		add_action( 'wp_enqueue_scripts', array( $this, 'ALPHAMAP_plugin_assets' ) );
	}
	...
	*/
	...
	public function ALPHAMAP_plugin_assets() {
		self::plugin_css();
		self::plugin_js();
	}
	...
	public function init_widgets( $widgets_manager ) {
		...
		require_once ALPHAMAP_PL_INCLUDE . '/Alpha_Google_Map.php';
		// Register widget
		$widgets_manager->register( new \Elementor\Alpha_Google_Map() );
	}
}
